    ...
    private function parseSheet(Worksheet $sheet): Collection
    {
        ...
        for ($rowIndex = 2; $rowIndex <= $highestRow; $rowIndex++) {
            ...
            $rows->push(new JournalRowData(
                ...
                partyType: $this->nullableString($sheet->getCell("J{$rowIndex}")->getValue()),
                partyCode: $this->nullableString($sheet->getCell("K{$rowIndex}")->getValue()),
                partyName: $this->nullableString($sheet->getCell("L{$rowIndex}")->getValue()),
                meta: [
                    'row_index' => $rowIndex,
                ],
            ));
