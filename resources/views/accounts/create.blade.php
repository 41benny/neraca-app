<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl leading-tight">Tambah Akun</h2>
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        <form method="POST" action="{{ route('accounts.store') }}" class="bg-white dark:bg-dark-bg-secondary border border-gray-100 dark:border-gray-700 rounded-lg shadow p-6 space-y-6">
            @csrf
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm text-gray-600 dark:text-gray-300 mb-1">Kode</label>
                    <input name="code" required class="w-full border border-gray-300 dark:border-gray-700 rounded px-3 py-2 bg-white dark:bg-dark-bg-primary text-gray-900 dark:text-dark-text-primary"/>
                </div>
                <div>
                    <label class="block text-sm text-gray-600 dark:text-gray-300 mb-1">Nama</label>
                    <input name="name" required class="w-full border border-gray-300 dark:border-gray-700 rounded px-3 py-2 bg-white dark:bg-dark-bg-primary text-gray-900 dark:text-dark-text-primary"/>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="number" name="level" min="1" class="w-full border border-gray-300 dark:border-gray-700 rounded px-3 py-2 bg-white dark:bg-dark-bg-primary text-gray-900 dark:text-dark-text-primary"/>
                </div>
                <div>
                    ...
                    <select name="normal_balance" class="w-full border border-gray-300 dark:border-gray-700 rounded px-3 py-2 bg-white dark:bg-dark-bg-primary text-gray-900 dark:text-dark-text-primary" required>
                        @foreach($normalBalances as $nb)
                            <option value="{{ $nb->value }}">{{ ucfirst($nb->value) }}</option>
                        @endforeach
                    </select>
                </div>
                <div>
                    <label class="block text-sm text-gray-600 dark:text-gray-300 mb-1">Tipe Akun</label>
                    <input name="account_type" value="general" class="w-full border border-gray-300 dark:border-gray-700 rounded px-3 py-2 bg-white dark:bg-dark-bg-primary text-gray-900 dark:text-dark-text-primary"/>
                </div>
                <div class="flex items-center gap-2">
                    <input type="checkbox" name="is_cash_account" value="1" class="h-4 w-4 border-gray-300 dark:border-gray-700"> <span class="text-sm text-gray-700 dark:text-gray-300">Akun Kas/Bank</span>
                </div>
                <div class="md:col-span-2">
                    <label class="block text-sm text-gray-600 dark:text-gray-300 mb-1">Deskripsi</label>
                    <input name="description" class="w-full border border-gray-300 dark:border-gray-700 rounded px-3 py-2 bg-white dark:bg-dark-bg-primary text-gray-900 dark:text-dark-text-primary"/>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    <input name="group_name" class="w-full border border-gray-300 dark:border-gray-700 rounded px-3 py-2 bg-white dark:bg-dark-bg-primary text-gray-900 dark:text-dark-text-primary"/>
                </div>
                <div>
                    ...
                    <select name="side" class="w-full border border-gray-300 dark:border-gray-700 rounded px-3 py-2 bg-white dark:bg-dark-bg-primary text-gray-900 dark:text-dark-text-primary">
                        <option value="">—</option>
                        @foreach($sides as $sd)
                            <option value="{{ $sd->value }}">{{ ucfirst($sd->value) }}</option>
                        @endforeach
                    </select>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="number" name="display_order" min="0" value="0" class="w-full border border-gray-300 dark:border-gray-700 rounded px-3 py-2 bg-white dark:bg-dark-bg-primary text-gray-900 dark:text-dark-text-primary"/>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-4 gap-4">
                <div>
                    ...
                    <input type="number" step="0.01" name="opening_debit" class="w-full border border-gray-300 dark:border-gray-700 rounded px-3 py-2 bg-white dark:bg-dark-bg-primary text-gray-900 dark:text-dark-text-primary"/>
                </div>
                <div>
                    <label class="block text-sm text-gray-600 dark:text-gray-300 mb-1">Saldo Awal Kredit</label>
                    <input type="number" step="0.01" name="opening_credit" class="w-full border border-gray-300 dark:border-gray-700 rounded px-3 py-2 bg-white dark:bg-dark-bg-primary text-gray-900 dark:text-dark-text-primary"/>
                </div>
                <div>
                    <label class="block text-sm text-gray-600 dark:text-gray-300 mb-1">Per Tanggal</label>
                    <input type="date" name="opening_as_of" value="{{ now()->startOfYear()->toDateString() }}" class="w-full border border-gray-300 dark:border-gray-700 rounded px-3 py-2 bg-white dark:bg-dark-bg-primary text-gray-900 dark:text-dark-text-primary"/>
                </div>
                <div>
                    <label class="block text-sm text-gray-600 dark:text-gray-300 mb-1">Cabang</label>
                    <input name="branch_code" class="w-full border border-gray-300 dark:border-gray-700 rounded px-3 py-2 bg-white dark:bg-dark-bg-primary text-gray-900 dark:text-dark-text-primary"/>
                </div>
            </div>
